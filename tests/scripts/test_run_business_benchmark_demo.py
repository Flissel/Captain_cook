...
def test_runner_contract_is_opt_in_redacted_and_factory_gated() -> None:
    ...
    assert "$seedVersion = 'business-benchmark-demo-2026-08-v36'" in source
    assert "'--suite-version', '36'" in source
...
""".strip(),
    ...
    assert plan == {
        ...
        "issued_at": plan["issued_at"],
            "suite_version": 36,
        "seed_version_id": "business-benchmark-demo-2026-08-v36",
    ...
    assert plan_arguments[plan_arguments.index("--suite-version") + 1] == "36"
    ...
    assert arguments[arguments.index("--suite-version") + 1] == "36"
...
print(json.dumps({
    ...
    'database': 'captain_test',
    'teams': [
        {'profile': 'claims', 'job': {'job_id': '71000000-0000-0000-0000-000000000001', 'execution_policy': {'allowed_models': ['gpt-4.1-mini'], 'max_cost_usd': '0.32'}}, 'suite': {'suite_version': 36}, 'candidate_id': 'claims-candidate'},
        {'profile': 'renewal', 'job': {'job_id': '71000000-0000-0000-0000-000000000002', 'execution_policy': {'allowed_models': ['gpt-4.1-mini'], 'max_cost_usd': '0.32'}}, 'suite': {'suite_version': 36}, 'candidate_id': 'renewal-candidate'},
    ],
}))
""".strip(),
        encoding="utf-8",
