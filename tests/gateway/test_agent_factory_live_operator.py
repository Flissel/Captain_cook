...
def test_total_cost_envelope_requires_subscription_codex_and_keeps_each_team_below_cap() -> None:
    environment = {
        ...
        "CAPTAIN_FACTORY_HERMES_MAX_TOTAL_USD": "0.10",
        "CAPTAIN_FACTORY_PRIOR_ATTEMPT_RESERVE_USD_PER_TEAM": "0.45",
    }

    validate_factory_total_cost_envelope(
        environment=environment,
        benchmark_maximum_usd_per_team=(Decimal("0.20"), Decimal("0.20")),
    )
